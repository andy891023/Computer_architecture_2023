...
void VTestTopModule::traceChgThis__4(VTestTopModule__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBus(c+25,(((0x35U >= (0x3fU & vlTOPp->TestTopModule__DOT__rom_loader__DOT__address))
                             ? vlTOPp->TestTopModule__DOT__instruction_rom__DOT__mem
                            [(0x3fU & vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)]
                             : 0U)),32);
        vcdp->chgBus(c+33,(((0x35U >= vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)
...
void VTestTopModule::traceChgThis__9(VTestTopModule__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBus(c+969,((IData)(((0x35U >= vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)
                                      ? (VL_ULL(0x7ffffffff) 
                                         & (VL_ULL(0x1000) 
                                            + ((QData)((IData)(vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)) 
                                               << 2U)))
                                      : VL_ULL(0)))),32);
        vcdp->chgBit(c+977,((0x35U >= vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)));
        vcdp->chgBit(c+985,(vlTOPp->TestTopModule__DOT__rom_loader__DOT__valid));
        vcdp->chgBus(c+993,((0x3fU & vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)),6);
    }
}
