...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/tbl/ca2023-lab3/test_run_dir/Single_Cycle_CPU_should_FP32_Operations_by_Applying_FP32_to_Bfloat16_Conversion_Algorithm/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/tbl/ca2023-lab3/test_run_dir/Single_Cycle_CPU_should_FP32_Operations_by_Applying_FP32_to_Bfloat16_Conversion_Algorithm/TestTopModule.vcd)";
