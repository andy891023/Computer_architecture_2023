...
void VTestTopModule::traceInitThis__1(VTestTopModule__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->declBus(c+993,"TestTopModule instruction_rom mem_io_data_MPORT_addr", false,-1, 7,0);
...
void VTestTopModule::traceFullThis__1(VTestTopModule__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBus(c+25,(((0x83U >= (0xffU & vlTOPp->TestTopModule__DOT__rom_loader__DOT__address))
                              ? vlTOPp->TestTopModule__DOT__instruction_rom__DOT__mem
                             [(0xffU & vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)]
                              : 0U)),32);
        vcdp->fullBus(c+33,(((0x83U >= vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)
        ...
        vcdp->fullBus(c+969,((IData)(((0x83U >= vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)
                                       ? (VL_ULL(0x7ffffffff) 
                                          & (VL_ULL(0x1000) 
                                             + ((QData)((IData)(vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)) 
                                                << 2U)))
                                       : VL_ULL(0)))),32);
        vcdp->fullBit(c+977,((0x83U >= vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)));
        vcdp->fullBit(c+985,(vlTOPp->TestTopModule__DOT__rom_loader__DOT__valid));
        vcdp->fullBus(c+993,((0xffU & vlTOPp->TestTopModule__DOT__rom_loader__DOT__address)),8);
